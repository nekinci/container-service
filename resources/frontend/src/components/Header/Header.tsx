    ...
    return (
        <Container style={{padding: '10px 0'}}>
            ...
            <div style={{display:'flex', justifyContent: 'space-between', padding: '0 14px'}}>
                <Link style={{ textDecoration: 'none', color: 'black', cursor: 'pointer' }} href={'/'}>
                ...
                <div style={{display: 'flex'}}>
                    ...
                    {!isLoggedIn && <Button onClick={() => event.emit('login', 'header')} variant={'text'} color={'secondary'}>Login</Button>}
                    {isLoggedIn && (
                        <>
